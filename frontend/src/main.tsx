...
const stageStatusLabel: Record<StageStatus, string> = { planned: '未开始', active: '进行中', blocked: '受阻', pending_acceptance: '待验收', completed: '已完成' };
const stageStatusTone: Record<StageStatus, string> = { planned: 'planning', active: 'active', blocked: 'blocked', pending_acceptance: 'pending-acceptance', completed: 'completed' };
